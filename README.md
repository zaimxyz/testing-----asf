...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/testing-----asf)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/testing-----asf
```

A live public deployment of this template is available at [https://testing-----asf.templates.workers.dev](https://testing-----asf.templates.workers.dev)
